    ...
    <nav class="border-gray-200 bg-main">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                <a href="#" class="text-gray-800 border-[1px] hover:border-white dark:text-white focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm p-1 lg:px-4 lg:py-2 lg:px-5 lg:py-2.5 focus:outline-none transition">Đăng nhập
            ...
            <div id="mega-menu" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                    <li>
                        <a href="#" class="block py-2 px-3 border-b border-gray-100  bg-transparent md:border-0  md:p-0 text-white md:dark:hover:text-hover dark:hover:text-hover md:dark:hover:bg-transparent dark:border-gray-700 transition" aria-current="page">Trang chủ</a>
                    </li>
                    <li>
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 bg-transparent md:border-0  md:p-0 dark:text-white md:dark:hover:text-hover  dark:hover:text-hover md:dark:hover:bg-transparent dark:border-gray-700 transition">Khuyến mãi hot</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 bg-transparent md:border-0  md:p-0 dark:text-white md:dark:hover:text-hover  dark:hover:text-hover md:dark:hover:bg-transparent dark:border-gray-700 transition">Liên hệ</a>
                    </li>
                </ul>
            </div>
        </div>
